...
export default function LoanManagement() {
    ...
    const loadLoans = async () => {
        try {
            ...
            const sortedLoans = response.data.sort(
                (a, b) => new Date(b.payment_start_date) - new Date(a.payment_start_date) //Sort by most recent
            );
    ...
    const confirmStatusChange = async () => {
        try {
            await axios.put(`http://localhost:8000/api/loans/update/${selectedLoanId}/`, { status: selectedNewStatus });
            ...
            {showConfirmModal && (
                <div className="fixed inset-0 bg-black/50 flex justify-center items-center z-50">
                    <div className="bg-white p-6 rounded-lg shadow-lg w-full max-w-md">
                        ...
                        <p className="mb-6">Are you sure you want to change the loan status to <strong>{selectedNewStatus}</strong>?</p>
